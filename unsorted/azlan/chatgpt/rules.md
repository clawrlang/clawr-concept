...
function mutateObject(mut obj):
    if obj.memory.ref_count > 1:
        ...
        new_memory = deep_copy(obj.memory) // new_memory is initialized with ref_count == 1
...
Let me know if you would like to see further examples or explore additional edge cases!
