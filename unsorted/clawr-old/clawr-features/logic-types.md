...
Clawr has two logic systems: *Boolean algebra* which is prevalent in most other languages, and *[ternary algebra](ternary-algebra.md)* which is built to accommodate future three-value hardware.
